...
class Formater():
    ...
    def filter_data_by_date(self, df,users_df, frac=0.1,count=100,year=2005,month=12,day=15):
        # get test users
        test_users_df = users_df[users_df['count']>count].sample(frac=frac)
        # filter user by rating count
    ...
    def make_sprase_matrix(self, df,ITEM_NUM):
